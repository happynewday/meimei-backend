...
public class ActorNew {
    ...
    public ActorNew(Integer id, String aname, String avatar, String adesc, String weibo, Date birth, Byte ht, Byte wt, Byte b, Byte w, Byte h, String cup, String homepage, Long createTime) {
        this.id = id;
        this.aname = aname;
        this.avatar = avatar;
        this.adesc = adesc;
